...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <img src="imgs/mon2.jpg" class="img-thumbnail rounded float-start" style="height: 100%;width:33%" alt="...">
            <img src="imgs/mon3.jpg" class="img-thumbnail rounded mx-auto d-block" style="height: 100%;width:33%" alt="...">
            <img src="imgs/mon5.jpg" class="img-thumbnail rounded float-end" style="height: 100%;width:33%" alt="...">
        </div>
    </div>
